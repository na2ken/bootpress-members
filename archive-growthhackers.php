<?php
/* Template Name: archive-growthhackers.php */
/* Template ID: archive-panel-3col template */
/* v1.0 */
get_header(); ?>
<!-- ◆ archive-panel-3col template ◆ -->
<div class="l-cover gryColor verticalPadding-t-0 verticalPadding-b-0">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="h2 text-center NotoSansJP-Thin verticalMargin-t-sm"><?php echo esc_html(get_post_type_object(get_post_type())->label ); ?></h1>
            </div>
        </div><!-- /.row -->
    </div>
</div><!-- /.l-cover -->
