<?php
/* Template Name: single-twdem.php */
/* Template ID: single-panel-sidebar bootstrap template */
/* v1.1 */
get_header(); ?>
<!-- ◆ single-panel-sidebar template （bootstrap）◆ -->
<div class="l-cover">
</div><!-- /.l-cover -->
...
<div class="row verticalMargin-t-sm verticalMargin-b-sm">
    <div class="horizontalPadding-l-xs horizontalPadding-r-xs">
        <h4 class="h4 NotoSansJP-Thin text-center keyColor20pale verticalPadding-t-xs verticalPadding-b-xs">関連記事まとめ</h4>
