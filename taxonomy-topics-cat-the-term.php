<?php
/* Template Name: taxonomy-topics-cat-the-term.php */
get_header(); ?>
<!-- ◆ taxonomy-topics-cat-the-term template ◆ -->
<div class="l-cover verticalPadding-t-xs verticalPadding-b-sm">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <h1 class="h2 text-center NotoSansJP-Thin ">知っておきたいWeb用語</h1>
            </div>
        </div><!-- /.row -->
    </div>
</div><!-- /.l-cover -->
                    ...
                    <?php endwhile; endif; ?>
                                        ...
                                        <div class="col-sm-3">
                                          ...
                                          <ul class="navListUnit">
                                              ...
                                              <li class="">
                                                <a href="http://www.iaowd.com/jp/topics-cat/wordpress/">WordPress</a>
                                              </li>
                                          </ul>
                                        </div>
